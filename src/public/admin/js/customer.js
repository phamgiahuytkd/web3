...
function searchTable() {
    ...
    document.querySelectorAll('.customer-table tbody tr:not(.hide)').forEach((visible_row, i) => {
...
function openModal_view_order() {
    document.getElementById("view_order_Modal").style.display = "block";
}

// Function to close the modal
function closeModal_view_order() {
    document.getElementById("view_order_Modal").style.display = "none";
}

// Event listener for the close button
document.querySelector('.close').addEventListener('click', closeModal_view_order);
